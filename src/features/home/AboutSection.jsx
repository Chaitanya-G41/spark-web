...
const DignitaryCard = ({ name, title, institution, photo, message, reverse }) => (
  ...
  >
    ...
    <div className="bg-sparkBlue text-white font-black text-base md:text-lg py-3 px-8 tracking-wider text-center uppercase border-b border-sparkLightBlue/50 shadow-inner">
      {title}
    </div>
    ...
    <div className={`flex flex-col ${reverse ? 'lg:flex-row-reverse' : 'lg:flex-row'} gap-8 p-8 md:p-10 items-center lg:items-start`}>
      ...
      <div className="flex flex-col items-center justify-start gap-5 lg:w-72 shrink-0">
        ...
        <div className="text-center">
          ...
          <p className="text-sparkAccent font-bold text-sm mt-1">{title}</p>
...
const dignitaries = [
  ...
  {
    name: 'Dr. Shanmukha N',
    title: 'Faculty Advisor & HoD, Mechanical Engineering',
    institution: 'RV College of Engineering',
  ...
  },
  {
    ...
    title: 'Faculty Co-ordinator & Assistant Professor, CSE',
    institution: 'RV College of Engineering',
